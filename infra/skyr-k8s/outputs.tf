...
output "minio_external_url" {
  ...
  description = "Public-facing MinIO/S3 base URL ADB surfaces to users (presigned and non-presigned). Falls back to minio_endpoint when minio_external_url is unset."
}
