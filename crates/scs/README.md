...
| `ofs-delta` | No | No | N/A (pack encoding) | Yes | Pack object type 6 is fully parsed and resolved. Base objects are looked up by offset within the packfile. Not advertised as a capability; support is inherent in the packfile parser. |
