        ...
        switch (tag) {
            ...
            case "Record":
                if (
                    inner &&
                    typeof inner === "object" &&
                    "fields" in (inner as Record<string, unknown>)
                ) {
                    const fields = (inner as Record<string, unknown>).fields as Record<
                        string,
                        unknown
                    >;
                    return { kind: "record", entries: Object.entries(fields) };
            ...
            case "Dict": {
                if (
                    inner &&
                    typeof inner === "object" &&
                    "entries" in (inner as Record<string, unknown>)
                ) {
