...
export type EnvironmentDetailQuery = { __typename?: 'Query', repositories: Array<{ __typename?: 'Repository', name: string, environments: Array<{ __typename?: 'Environment', name: string, qid: string, deployments: Array<{ __typename?: 'Deployment', id: string, ref: string, createdAt: string, state: DeploymentState, commit: { __typename?: 'Commit', hash: string, message: string }, resources: Array<{ __typename?: 'Resource', type: string, name: string, inputs?: any | null, outputs?: any | null, markers: Array<ResourceMarker> }>, artifacts: Array<{ __typename?: 'Artifact', namespace: string, name: string, mediaType: string, url: string }>, lastLogs: Array<{ __typename?: 'Log', severity: Severity, timestamp: string, message: string }> }>, resources: Array<{ __typename?: 'Resource', type: string, name: string, inputs?: any | null, outputs?: any | null, markers: Array<ResourceMarker>, owner?: { __typename?: 'Deployment', id: string } | null, dependencies: Array<{ __typename?: 'Resource', type: string, name: string }> }> }> }> };
...
export type RepositoriesQuery = { __typename?: 'Query', repositories: Array<{ __typename?: 'Repository', name: string, environments: Array<{ __typename?: 'Environment', name: string, qid: string, deployments: Array<{ __typename?: 'Deployment', id: string, ref: string, state: DeploymentState, commit: { __typename?: 'Commit', hash: string, message: string } }> }> }> };
...
export type DeploymentTreeQuery = { __typename?: 'Query', repositories: Array<{ __typename?: 'Repository', name: string, environments: Array<{ __typename?: 'Environment', name: string, deployments: Array<{ __typename?: 'Deployment', id: string, commit: { __typename?: 'Commit', hash: string, treeEntry?: { __typename: 'Blob', hash: string, name?: string | null, size: number, content?: string | null } | { __typename: 'Tree', hash: string, name?: string | null, entries: Array<{ __typename: 'Blob', hash: string, name?: string | null, size: number } | { __typename: 'Tree', hash: string, name?: string | null }> } | null } }> }> }> };

export type DeploymentRootTreeQueryVariables = Exact<{ [key: string]: never; }>;


export type DeploymentRootTreeQuery = { __typename?: 'Query', repositories: Array<{ __typename?: 'Repository', name: string, environments: Array<{ __typename?: 'Environment', name: string, deployments: Array<{ __typename?: 'Deployment', id: string, commit: { __typename?: 'Commit', hash: string, message: string, tree: { __typename?: 'Tree', hash: string, entries: Array<{ __typename: 'Blob', hash: string, name?: string | null, size: number } | { __typename: 'Tree', hash: string, name?: string | null }> } } }> }> }> };
