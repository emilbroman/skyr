...
export type SignInMutation = { __typename?: 'Mutation', signin: { __typename?: 'AuthSuccess', token: string, user: { __typename?: 'SignedInUser', username: string, email: string, fullname?: string | null, region: string, publicKeys: Array<string> } } };
...
export type SignupMutation = { __typename?: 'Mutation', signup: { __typename?: 'AuthSuccess', token: string, user: { __typename?: 'SignedInUser', username: string, email: string, fullname?: string | null, region: string, publicKeys: Array<string> } } };

export type RefreshTokenQueryVariables = Exact<{ [key: string]: never; }>;


export type RefreshTokenQuery = { __typename?: 'Query', refreshToken: { __typename?: 'AuthSuccess', token: string, user: { __typename?: 'SignedInUser', username: string, email: string, fullname?: string | null, region: string, publicKeys: Array<string> } } };

export type MeQueryVariables = Exact<{ [key: string]: never; }>;


export type MeQuery = { __typename?: 'Query', me: { __typename?: 'SignedInUser', username: string, email: string, fullname?: string | null, region: string, publicKeys: Array<string> } };
...
export type EnvironmentDetailQuery = { __typename?: 'Query', organization: { __typename?: 'Organization', repository: { __typename?: 'Repository', environment: { __typename?: 'Environment', name: string, qid: string, incidents: Array<{ __typename?: 'Incident', id: string, closedAt?: string | null }>, deployments: Array<{ __typename?: 'Deployment', id: string, shortId: string, createdAt: string, state: DeploymentState, bootstrapped: boolean, commit: { __typename?: 'Commit', hash: string, message: string }, status: { __typename?: 'StatusSummary', health: HealthStatus, lastReportAt: string, lastReportSucceeded: boolean, openIncidentCount: number, consecutiveFailureCount: number }, resources: Array<{ __typename?: 'Resource', type: string, region: string, name: string, inputs?: any | null, outputs?: any | null, markers: Array<ResourceMarker>, sourceTrace: Array<{ __typename?: 'SourceFrame', moduleId: string, span: string, name: string }> }>, lastLogs: Array<{ __typename?: 'Log', severity: Severity, timestamp: string, message: string }> }>, artifacts: Array<{ __typename?: 'Artifact', name: string, mediaType: string, url: string }>, resources: Array<{ __typename?: 'Resource', type: string, region: string, name: string, inputs?: any | null, outputs?: any | null, markers: Array<ResourceMarker>, owner?: { __typename?: 'Deployment', id: string } | null, dependencies: Array<{ __typename?: 'Resource', type: string, region: string, name: string }>, sourceTrace: Array<{ __typename?: 'SourceFrame', moduleId: string, span: string, name: string }>, status: { __typename?: 'StatusSummary', health: HealthStatus, lastReportAt: string, lastReportSucceeded: boolean, openIncidentCount: number, consecutiveFailureCount: number } }> } } } };
...
export type AvailableRegionsQuery = { __typename?: 'Query', availableRegions: Array<string> };
