    ...
    repository: {
      ...
      environment: {
        ...
        deployments: Array<{
          ...
          createdAt: string;
          state: DeploymentState;
          commit: { __typename?: "Commit"; hash: string; message: string };
          resources: Array<{
            __typename?: "Resource";
            type: string;
            name: string;
        ...
        resources: Array<{
          ...
          outputs?: any | null;
          markers: Array<ResourceMarker>;
          owner?: { __typename?: "Deployment"; id: string } | null;
          dependencies: Array<{
            __typename?: "Resource";
            type: string;
            name: string;
...
export type DeploymentDetailQuery = {
  __typename?: "Query";
  organization: {
    __typename?: "Organization";
    repository: {
...
export type EnvironmentLogsSubscription = {
  __typename?: "Subscription";
  environmentLogs: {
    __typename?: "Log";
    severity: Severity;
...
export type ResourceLogsSubscription = {
  __typename?: "Subscription";
  resourceLogs: {
    __typename?: "Log";
    severity: Severity;
...
export type OrganizationsQuery = {
  ...
  organizations: Array<{
    __typename?: "Organization";
    name: string;
    repositories: Array<{ __typename?: "Repository"; name: string }>;
  }>;
};
...
export type CommitTreeEntryQuery = {
  __typename?: "Query";
  organization: {
    __typename?: "Organization";
    repository: {
...
export type CommitRootTreeQuery = {
  __typename?: "Query";
  organization: {
    __typename?: "Organization";
    repository: {
...
} as unknown as DocumentNode<AuthChallengeQuery, AuthChallengeQueryVariables>;
...
export const EnvironmentDetailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "EnvironmentDetail" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
  ...
  EnvironmentDetailQuery,
  EnvironmentDetailQueryVariables
>;
...
export const DeploymentDetailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "DeploymentDetail" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "org" } },
  ...
  DeploymentDetailQueryVariables
>;
export const DeploymentLogsDocument = {
  ...
  DeploymentLogsSubscription,
  DeploymentLogsSubscriptionVariables
>;
export const EnvironmentLogsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "EnvironmentLogs" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "environmentQid" },
          },
          type: {
            kind: "NonNullType",
            type: {
...
>;
export const ResourceLogsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "ResourceLogs" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "resourceQid" },
          },
          type: {
            kind: "NonNullType",
            type: {
...
export const OrganizationDetailDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
export const CommitTreeEntryDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CommitTreeEntry" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "org" } },
  ...
  CommitTreeEntryQuery,
  CommitTreeEntryQueryVariables
>;
export const CommitRootTreeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CommitRootTree" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "org" } },
...
} as unknown as DocumentNode<CommitRootTreeQuery, CommitRootTreeQueryVariables>;
