...
export type Mutation = {
   ...
   */
  makeDeploymentDesired: Deployment;
...
export type MutationMakeDeploymentDesiredArgs = {
...
export type EnvironmentDetailQuery = { __typename?: 'Query', organization: { __typename?: 'Organization', repository: { __typename?: 'Repository', environment: { __typename?: 'Environment', name: string, qid: string, deployments: Array<{ __typename?: 'Deployment', id: string, ref: string, createdAt: string, state: DeploymentState, commit: { __typename?: 'Commit', hash: string, message: string }, resources: Array<{ __typename?: 'Resource', type: string, name: string, inputs?: any | null, outputs?: any | null, markers: Array<ResourceMarker>, sourceTrace: Array<{ __typename?: 'SourceFrame', moduleId: string, span: string, name: string }> }>, lastLogs: Array<{ __typename?: 'Log', severity: Severity, timestamp: string, message: string }> }>, artifacts: Array<{ __typename?: 'Artifact', name: string, mediaType: string, url: string }>, resources: Array<{ __typename?: 'Resource', type: string, name: string, inputs?: any | null, outputs?: any | null, markers: Array<ResourceMarker>, owner?: { __typename?: 'Deployment', id: string } | null, dependencies: Array<{ __typename?: 'Resource', type: string, name: string }>, sourceTrace: Array<{ __typename?: 'SourceFrame', moduleId: string, span: string, name: string }> }> } } } };
...
export type MakeDeploymentDesiredMutationVariables = Exact<{
  org: Scalars['String']['input'];
  repo: Scalars['String']['input'];
  env: Scalars['String']['input'];
  commit: Scalars['String']['input'];
...
export type MakeDeploymentDesiredMutation = { __typename?: 'Mutation', makeDeploymentDesired: { __typename?: 'Deployment', id: string, state: DeploymentState } };
...
export type DeploymentDetailQuery = { __typename?: 'Query', organization: { __typename?: 'Organization', repository: { __typename?: 'Repository', environment: { __typename?: 'Environment', deployment: { __typename?: 'Deployment', id: string, ref: string, createdAt: string, state: DeploymentState, commit: { __typename?: 'Commit', hash: string, message: string }, resources: Array<{ __typename?: 'Resource', type: string, name: string, inputs?: any | null, outputs?: any | null, markers: Array<ResourceMarker>, owner?: { __typename?: 'Deployment', id: string } | null, dependencies: Array<{ __typename?: 'Resource', type: string, name: string }>, sourceTrace: Array<{ __typename?: 'SourceFrame', moduleId: string, span: string, name: string }> }>, lastLogs: Array<{ __typename?: 'Log', severity: Severity, timestamp: string, message: string }> } } } } };
...
export const MakeDeploymentDesiredDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MakeDeploymentDesired"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"org"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"repo"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"env"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"commit"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"makeDeploymentDesired"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"organization"},"value":{"kind":"Variable","name":{"kind":"Name","value":"org"}}},{"kind":"Argument","name":{"kind":"Name","value":"repository"},"value":{"kind":"Variable","name":{"kind":"Name","value":"repo"}}},{"kind":"Argument","name":{"kind":"Name","value":"environment"},"value":{"kind":"Variable","name":{"kind":"Name","value":"env"}}},{"kind":"Argument","name":{"kind":"Name","value":"deployment"},"value":{"kind":"Variable","name":{"kind":"Name","value":"commit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"state"}}]}}]}}]} as unknown as DocumentNode<MakeDeploymentDesiredMutation, MakeDeploymentDesiredMutationVariables>;
