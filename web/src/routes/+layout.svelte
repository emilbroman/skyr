  ...
  <div class="min-h-screen bg-gray-100 flex flex-col">
    ...
    >
      <div class="flex items-center gap-4">
        ...
        <a
          href="/~docs/"
          class="relative {page.url.pathname.startsWith('/~docs/') ? 'text-gray-900 font-medium after:absolute after:left-0 after:right-0 after:mt-1 after:top-full after:h-0.5 after:bg-blue-600' : 'text-gray-500'} hover:text-gray-800 transition-colors"
        >
          Docs
        </a>
        <a
          href="/~playground"
          class="relative {page.url.pathname === '/~playground' ? 'text-gray-900 font-medium after:absolute after:left-0 after:right-0 after:mt-1 after:top-full after:h-0.5 after:bg-blue-600' : 'text-gray-500'} hover:text-gray-800 transition-colors"
        >
          Playground
        </a>
      </div>
